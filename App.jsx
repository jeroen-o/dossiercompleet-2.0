          ...
          {isFilled(state.heeftAlimentatie) && (
            <div style={{ marginTop: 24 }}>
              ...
              <div className="info-box neutral" style={{ marginTop: 0, marginBottom: 14 }}>
                ...
                <a href="https://www.bkr.nl" target="_blank" rel="noopener noreferrer" style={{ color: '#0C3B2A', fontWeight: 500 }}>
                  www.bkr.nl
                </a>.
              </div>
              <ChoiceGroup
  ...
  return (
    <div id="result-section" className="result">
      ...
      <div className="begroting">
        ...
        <div className={`begroting-saldo ${begroting.saldo >= 0 ? 'positive' : 'negative'}`}>
          <div className="saldo-label">
            <span className="saldo-titel">{begroting.saldo >= 0 ? '✓ Saldo (overschot)' : '⚠ Tekort'}</span>
            <span>
              {begroting.saldo >= 0
          ...
          <div className="saldo-value">{fmtCur(begroting.saldo)}</div>
        </div>
      </div>
