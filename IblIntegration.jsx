  ...
  return (
    <div className="ibl-modal-overlay show" onClick={onClose}>
      <div className="ibl-modal" onClick={(e) => e.stopPropagation()}>
        ...
        <p style={{ fontSize: 12, color: '#707672', marginBottom: 12 }}>
        ...
        <div className="ibl-modal-info">
          ...
          <dd>
            <strong style={{ color: '#0C3B2A' }}>{resultaat.primaryCategory}</strong>
          </dd>
          <dt>Samenstelling:</dt>
          ...
          <dt>Toetsinkomen:</dt>
          <dd>
            <strong style={{ color: '#0C3B2A', fontSize: 16 }}>
        ...
        <h4>Toelichting</h4>
        <p style={{ fontSize: 13, color: '#4A4F4B', lineHeight: 1.6 }}>
          ...
          <tbody>
            {resultaat.werkgeverResults.map((wr, i) => (
              <tr key={i}>
                ...
                <td style={{ fontSize: 12, color: '#707672' }}>
        ...
        {resultaat.werkgeverResults.some((wr) => wr.berekening?.detail) && (
          <>
            ...
            <div style={{ fontSize: 12, color: '#4A4F4B' }}>
